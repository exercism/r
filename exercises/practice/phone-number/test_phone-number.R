...
test_that("invalid when 9 digits", {
  expect_null(parse_phone_number("123456789"))
})

test_that("invalid when 11 digits and not starting with a 1", {
  expect_null(parse_phone_number("22234567890"))
})
